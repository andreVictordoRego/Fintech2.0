...
public class UsuarioDAOTeste {
	...
	public static void main(String[] args) throws DBException, SQLException {
		...
		Usuario usuario = new Usuario(65881, "Andre Victor", LocalDate.of(1991, 03, 28), "Masculino", "email@email.com", imagem, "12X3456");
		Usuario usuarioTesteEditado = new Usuario(65881, "Maria Victor", LocalDate.of(1991, 9, 30), "FEM", "email@email.comxxx", null, "12X3456");
